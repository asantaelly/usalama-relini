            ...
            <div class="col-12">
                ...
                <table class="table mb-0">
                    ...
                    <tr>
                        ...
                        <td class="px-0">
                            <span class="h6 text-sm">MICHAEL OMAKEI</span>
                        </td>
                        <td class="px-0">
                            <span class="h6 text-sm">20-03-2020 17:18:12</span>
                        </td>
                        <td class="px-0">
                            <span class="h6 text-sm">TEXT RECEIVED</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="px-0">
        ...
        <div class="col-12 col-md-12">
            ...
            <div class="table-responsive">
                <table class="table mb-0">
                    ...
                    <tr>
                        <td class="px-1">
                        <span class="h6 text-sm">20-02-2020 16:56:12</span>
                        </td>
                        <td class="px-5">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus dolor commodi quasi saepe corrupti, atque natus! Accusamus fugiat, voluptates soluta expedita tenetur necessitatibus natus! Consequuntur tenetur laborum hic nihil ullam.
                        </td>
                    </tr>
                    </tbody>
                </table>
