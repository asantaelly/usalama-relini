      ...
      <form action="{{route('report.store')}}" method="POST">
        ...
        <div class="row" >
          <div class="form-group col-lg-4">
            ...
            <select id="accident_subject" name="accident_subject[][id]" class="custom-select selected-tags" multiple="multiple">
              <option value=""  disabled>Select Accident Subject</option>
              @foreach ($accidents as $accident)
                <option value="{{$accident->id}}">{{$accident->accident_subject}}</option>
              @endforeach
            </select>
          </div>
          <div class="form-group col-lg-4">
            <label for="cause_of_accident">Cause Of Accident</label> 
            <select id="cause_of_accident" name="cause_of_accident[][id]" class="custom-select selected-tags" multiple="multiple">
              <option value=""  disabled>Select Cause Of Accident</option>
              @foreach ($accidents as $accident)
                <option value="{{$accident->id}}">{{$accident->cause_of_accident}}</option>
              @endforeach
            </select>
          </div>
          <div class="form-group col-lg-4">
            <label for="belonged_quarter">Belonged Quarter</label> 
            <select id="belonged_quarter" name="belonged_quarter" class="custom-select">
        ...
        <div class="row">
          <div class="form-group col-lg-4">
            ...
            <select id="oparation_year" name="oparation_year" class="custom-select">
        ...
        <h5 class="text-sm mt-5"> Include In Report </h5><hr>
          ...
          <div class="row">
            <div class="form-group col-lg-3 pl-0">
              <label for="toco_trolley">Loco/Trolley</label> <br>
              <input id="toco_trolley" name="toco_trolley" placeholder="Loco / Trolley" type="checkbox">
            </div>
          ...
          <h5 class="text-sm mt-5">Report Count By </h5><hr>
          <div class="row mb-5">
            <div class="form-group col-lg-2 pl-0">
              <label for="death_nature">Death Nature</label> <br>
              <input id="death_nature" name="count_by" placeholder="Death Nature" value="death_nature" type="radio">
            </div>
            <div class="form-group col-lg-2 pl-0">
              <label for="injury_nature">Injury Nature</label> <br>
              <input id="injury_nature" name="count_by" placeholder="Injury Nature" value="injury_nature" type="radio">
            </div>
            <div class="form-group col-lg-2 pl-0">
              <label for="accident_subject_count">Accident Subject</label> <br>
              <input id="accident_subject_count" name="count_by" value="accident_subject_count" placeholder="Accident Subject" type="radio">
            </div>
            <div class="form-group col-lg-2 pl-0">
              <label for="cause_of_accident_count">Cause Of Accident</label> <br>
              <input id="cause_of_accident_count" name="count_by" value="cause_of_accident_count" placeholder="Cause Of Accident" type="radio">
            </div>
            <div class="form-group col-lg-3 pl-0">
              <label for="toco_trolley">Loco/Trolley</label> <br>
              <input id="toco_trolley" name="count_by" value="toco_trolley" placeholder="Loco / Trolley" type="radio">
            </div>
          </div>
