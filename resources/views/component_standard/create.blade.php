		...
		<form action="{{route('components.store')}}" method="POST">
			...
			<div class="row" >
				<div class="form-group col-lg-8">
					...
					<input id="component" name="component" placeholder="Component Name" type="text" required="required" class="form-control @error('component') is-invalid @enderror">
					@error('component')
			...
			<div class="row input_fields_wrap_standard">
				<div class="form-group col-lg-4">
					...
					<input id="standard" name="standard[0][standard]" placeholder="Standard" type="text" required="required" class="form-control @error('standard') is-invalid @enderror">
					@error('standard')
					<span class="invalid-feedback" role="alert">
								<strong>{{ $message }}</strong>
						</span>
